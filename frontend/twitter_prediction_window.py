...
class TwitterPredictionWindow:
    def __init__(self, root):
        ...
        self.result_label = tk.Label(self.root, text="", bg=bg_color, fg=text_color, font=midi_font)
    ...
    def predict_personality(self):
        ...
        tweet_count = self.tweet_entry.get()
        ...
        # Wylosowanie wartości osobowości
        personality_types = ["ENTP","INTP","ENTJ","INTJ","ENFP","INFP","ENFJ","INFJ","ESTJ","ISTJ","ESFJ","ISFJ","ESTP","ISTP","ESFP","ISFP",]
        result = random.choice(personality_types)

        # Wyświetlenie wyniku predykcji
        self.result_label.config(text="Wynik predykcji: " + result)
